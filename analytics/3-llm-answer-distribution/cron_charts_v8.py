...
import os
DB = sys.argv[1] if len(sys.argv) > 1 else "/datav/markov_v8.db"
OUT = sys.argv[2] if len(sys.argv) > 2 else "/work/v8_progress.png"
...
fig.suptitle("Markov v8 (thinking ON) - 'Pick a number between 10 and 30'  -  %s  -  exp=%d  t=%.0fs"
